namespace UnoPlayground.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "SiwiecSoft.UnoPlayground";
    public readonly static string AndroidAppName = "SiwiecSoft.UnoPlayground";
